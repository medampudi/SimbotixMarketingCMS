...
const termsPage = () => (
  <Layout seoTitle={`Terms - ${website.titleAlt}`}>
    <Box
      width="xlarge"
      pad="large"
      margin="medium"
    ...
    >
      <>
        ...
        <Paragraph fill>
          This website is operated by Simbotix Private Limited. Throughout the
          site, the terms “we”, “us” and “our” refer to Simbotix Private
          Limited. Simbotix Private Limited offers this website, including all
        ...
        <Heading level={3}>SECTION 1 - ONLINE STORE TERMS</Heading>
        ...
        <Heading level={3}>SECTION 2 - GENERAL CONDITIONS</Heading>
        ...
        <Heading level={3}>SECTION 5 - PRODUCTS OR SERVICES</Heading>

        <Paragraph fill>
          Certain products or services may be available exclusively online
          through the website. These products or services may have limited
          quantities and are subject to return or exchange only according to our{" "}
          <Anchor href="/refunds">Returns Policy.</Anchor>
        </Paragraph>
        <Paragraph fill>
        ...
        <Heading level={3}>SECTION 7 - OPTIONAL TOOLS</Heading>
        ...
        <Heading level={3}>SECTION 8 - THIRD-PARTY LINKS</Heading>
        ...
        <Heading level={3}>SECTION 10 - PERSONAL INFORMATION</Heading>

        <Paragraph fill>
          Your submission of personal information through the store is governed
          by our <Anchor href="/privacy">Privacy Policy.</Anchor>
        </Paragraph>
        ...
        <Heading level={3}>SECTION 12 - PROHIBITED USES</Heading>
        ...
        <Paragraph fill>
          In no case shall Simbotix Private Limited, our directors, officers,
        ...
        <Heading level={3}>SECTION 14 - INDEMNIFICATION</Heading>

        <Paragraph fill>
          You agree to indemnify, defend and hold harmless Simbotix Private
        ...
        <Heading level={3}>SECTION 15 - SEVERABILITY</Heading>
        ...
        <Heading level={3}>SECTION 16 - TERMINATION</Heading>
        ...
        <Heading level={3}>SECTION 17 - ENTIRE AGREEMENT</Heading>
        ...
        <Heading level={3}>SECTION 18 - GOVERNING LAW</Heading>

        <Paragraph fill>
          These Terms of Service and any separate agreements whereby we provide
          you Services shall be governed by and construed in accordance with the
          laws of India and jurisdiction of Hyderabad, Telangana, India.
        </Paragraph>

        <Heading level={3}>SECTION 19 - CHANGES TO TERMS OF SERVICE</Heading>
        ...
        <Heading level={3}>SECTION 20 - CONTACT INFORMATION</Heading>
